...
export const metadata = {
  ...
  description: "Contact Suites Angelica about monthly, seasonal, and long-term apartment rentals in Bucerias' Golden Zone.",
};
      ...
      <section className="bg-white">
        <Container>
          <div className="mx-auto max-w-[780px] py-16 text-center md:py-24">
            ...
            <p className="mt-6 text-[17px] leading-[1.7] text-slate-900/70">Tell us when you would like to stay, how long you are planning to be in Bucerias, and how many guests will be staying. We will reply with clear information about availability and options.</p>
          </div>
        </Container>
      </section>
        ...
        <div className="mx-auto max-w-[1100px] px-6 py-16 md:py-24">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-12 md:gap-16">
            <div className="space-y-6 md:col-span-6">
              ...
              <p className="text-[17px] leading-[1.7] text-slate-900/75">We know many of our guests are planning from Canada and want straightforward answers before making a decision. Send us your dates and questions, and we will help you understand which apartment may work best.</p>
              <div className="rounded-2xl border border-slate-200 bg-white p-5 text-[15px] leading-[1.75] text-slate-700 shadow-sm">
                ...
                <p className="mt-2">Preferred arrival and departure dates, number of guests, desired length of stay, and whether ground-floor access is important.</p>
              </div>
      ...
      <section className="bg-white">
        <Container>
          <div className="mx-auto max-w-[700px] space-y-4 py-16 text-center md:py-24">
            <h3 className="font-serif text-3xl leading-[1.12] tracking-tight text-slate-900 md:text-4xl">A practical place for a longer Bucerias stay.</h3>
            <p className="text-[17px] text-slate-900/75">Comfortable, simple apartments in a walkable Golden Zone location, about 3 blocks from the beach.</p>
          </div>
        </Container>
      </section>
    </div>
